...
All of the tests of RenderCV are written in [`tests/`](https://github.com/rendercv/cvforge/tree/main/tests) directory.
...
Some tests in [`tests/renderer/`](https://github.com/rendercv/cvforge/tree/main/tests/renderer) (specifically [`test_pdf_png.py`](https://github.com/rendercv/cvforge/blob/main/tests/renderer/test_pdf_png.py), [`test_typst.py`](https://github.com/rendercv/cvforge/blob/main/tests/renderer/test_typst.py), [`test_markdown.py`](https://github.com/rendercv/cvforge/blob/main/tests/renderer/test_markdown.py), and [`test_html.py`](https://github.com/rendercv/cvforge/blob/main/tests/renderer/test_html.py)) use reference file comparison:
...
Coverage is a measure of which code lines are executed when tests run. If tests execute a line, it's included in coverage. If tests execute all lines in `src/cvforge/`, coverage is 100%.
