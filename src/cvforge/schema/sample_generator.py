...
def create_sample_cvforge_pydantic_model(
...
def create_sample_yaml_input_file(
    *,
    ...
    data_model_as_dictionary = cvforge_model_to_dictionary(data_model)
    ...
    schema_comment = (
        ...
        f" $schema=https://raw.githubusercontent.com/cvforge/cvforge/refs/tags/v{__version__}/schema.json\n"
    )
...
def cvforge_model_to_dictionary(data_model: RenderCVModel) -> dict:
...
def create_sample_cv_file(
    *,
    ...
    dictionary = cvforge_model_to_dictionary(data_model)
...
def create_sample_design_file(
    *,
    ...
    data_model = create_sample_cvforge_pydantic_model(theme=theme)
    dictionary = cvforge_model_to_dictionary(data_model)
    return create_sample_yaml_file(
...
def create_sample_locale_file(
    *,
    ...
    data_model = create_sample_cvforge_pydantic_model(locale=locale)
    dictionary = cvforge_model_to_dictionary(data_model)
    return create_sample_yaml_file(
