...
def build_cvforge_model_from_commented_map(
...
def build_cvforge_dictionary_and_model(
    main_yaml_file: str,
    *,
    input_file_path: pathlib.Path | None = None,
    **kwargs: Unpack[BuildRendercvModelArguments],
    ...
    """
    d, overlay_sources = build_cvforge_dictionary(main_yaml_file, **kwargs)
    m = build_cvforge_model_from_commented_map(d, input_file_path, overlay_sources)
    return d, m
