...
def get_cvforge_sections(
    ...
    """
    sections_cvforge: list[BaseRenderCVSection] = []
    ...
    if sections is not None:
        ...
        if section_order:
            ...
            for title in section_order:
                if title in sections_lookup:
                    ordered_keys.append(sections_lookup[title][0])
        ...
        for title in ordered_keys:
            ...
            sections_cvforge.append(section)

    return sections_cvforge
