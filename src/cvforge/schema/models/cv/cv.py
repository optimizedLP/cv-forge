...
from .section import BaseRenderCVSection, Section, get_cvforge_sections
...
class Cv(BaseModelWithoutExtraKeys):
    ...
    _section_order: list[str] | None = pydantic.PrivateAttr(default=None)

    @functools.cached_property
    def cvforge_sections(self) -> list[BaseRenderCVSection]:
        ...
        """
        return get_cvforge_sections(self.sections, self._section_order)
