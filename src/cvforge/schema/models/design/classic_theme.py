...
from cvforge.schema.models.base import BaseModelWithoutExtraKeys
from cvforge.schema.models.design.color import Color
from cvforge.schema.models.design.font_family import FontFamily as FontFamilyType
