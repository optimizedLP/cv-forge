...
#connections(
  ...
  [#link("https://linkedin.com/in/cvforge", icon: false, if-underline: false, if-color: false)[linkedin.com\/in\/cvforge]],
  [#link("https://github.com/cvforge", icon: false, if-underline: false, if-color: false)[github.com\/cvforge]],
)
