...
#education-entry(
  ...
  main-column-second-row: [
    PhD in Computer Science — Princeton, NJ
...
#education-entry(
  ...
  main-column-second-row: [
    BS in Computer Engineering — Istanbul, Türkiye
...
#regular-entry(
  [
    ...
    #emph[Nexus AI] — San Francisco, CA
...
#regular-entry(
  [
    ...
    #emph[NVIDIA Research] — Santa Clara, CA
...
#regular-entry(
  [
    ...
    #emph[Google DeepMind] — London, UK
...
#regular-entry(
  [
    ...
    #emph[Apple ML Research] — Cupertino, CA
...
#regular-entry(
  [
    ...
    #emph[Microsoft Research] — Redmond, WA
