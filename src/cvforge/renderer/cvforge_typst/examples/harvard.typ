...
#connections(
  ...
  [#link("https://linkedin.com/in/cvforge", icon: false, if-underline: false, if-color: false)[cvforge]],
  [#link("https://github.com/cvforge", icon: false, if-underline: false, if-color: false)[cvforge]],
)
