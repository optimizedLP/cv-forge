...
@app.command(
    name="new",
    help=(
        "Generate a YAML input file to get started. Example: [yellow]cvforge new"
        ' "John Doe"[/yellow]. Details: [cyan]cvforge new --help[/cyan]'
    ),
)
@handle_user_errors
def cli_command_new(
...
def build_creation_panel(
    ...
    lines.append(f"  2. Run: [cyan]cvforge render {input_file_path}[/cyan]")
